        ...
        <form className='mt-16' onSubmit={handleSubmit(onSubmit)}>
            <div className="flex md:flex-row flex-col gap-2 md:items-center justify-between  container">
                <div className='md:w-[450px] w-full shadow-md'>
                    <div className={`flex items-center py-4 px-6 gap-4 darkmode_components rounded`}>
                        <FontAwesomeIcon className='text-xl text-[#E6E6E6]' icon={faMagnifyingGlass} />
                ...
                <select value={selectField} onChange={(e) => setSelectField(e.target.value)} className="acessibility_outline shadow-md md:w-[200px] w-full darkmode_components py-4 px-2 rounded font-semibold">
